...
@section('content')
  <table class="table table-hover align-middle bg-white border text-secondary">
      <thead class="small table-primary text-secondary small">
        <tr>
            <th></th>
            <th></th>
            <th>CATEGORY</th>
      ...
      @forelse ($all_posts as $post)
          <tr>
              ...
              <td>
                @forelse ($post->categoryPost as $category_post)
                 ...
                 @empty
                     <div class="badge bg-secondary text-wrap">Uncategorized</div>
                @endforelse
          </td>
        ...
        @empty
          <tr>
              <td colspan="" class="text text-muted text-center">No posts found.</td>
          </tr>
      @endforelse
    </tbody>
  </table>
